  ...
  return (
    <>
      <Head>
        ...
        <title>Privacy Policy | No Cure No Pay</title>
      </Head>
    ...
    <div className=" show_deta">
        <div className="container pxx">
            <div className="all_services" dangerouslySetInnerHTML={{ __html: policy.content_body }}>
...
export async function getServerSideProps({ req, res}) {
  ...
  if (!langSelected.langSelected){ 
    ...
    const response=await axios.get(`/get-static-content?lang=${lang}&slug=privacy_policy`);
